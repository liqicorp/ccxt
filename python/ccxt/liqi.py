...
class liqi(Exchange):
    ...
    def fetch_currencies(self, limit, params={}):
        request = {
            'limit': limit or 1000,
        }
    ...
    def fetch_orders(self, symbol, limit, since=None, params={}):
        if symbol is None:
    ...
    def fetch_tickers(self, limit, params={}):
        request = {
            'limit': limit or 1000,
        }
    ...
    def fetch_ohlcv(self, symbol, internal='1m', limit=500, params={}):
        request = {
            'symbol': symbol,
            'interval': internal,
            'limit': limit,
    ...
    def create_order(self, symbol, type, side, amount=None, price=None, quoteAmount=None, params={}):
        request = {
            'symbol': symbol,
            'type': type,
            'side': side,
