...
class ImplicitAPI:
    ...
    private_get_v1_portfolios = privateGetV1Portfolios = Entry('v1/portfolios', 'private', 'GET', {})
    private_get_v1_portfolios_portfolio_id = privateGetV1PortfoliosPortfolioId = Entry('v1/portfolios/{portfolio_id}', 'private', 'GET', {})
    private_get_v1_portfolios_portfolio_id_balances = privateGetV1PortfoliosPortfolioIdBalances = Entry('v1/portfolios/{portfolio_id}/balances', 'private', 'GET', {})
    ...
    private_post_v1_portfolios_portfolio_id_order = privatePostV1PortfoliosPortfolioIdOrder = Entry('v1/portfolios/{portfolio_id}/order', 'private', 'POST', {})
    private_post_v1_portfolios_portfolio_id_orders_order_id_cancel = privatePostV1PortfoliosPortfolioIdOrdersOrderIdCancel = Entry('v1/portfolios/{portfolio_id}/orders/{order_id}/cancel', 'private', 'POST', {})
