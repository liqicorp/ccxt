...
use ccxt\async\abstract\liqi as Exchange;
...
class liqi extends Exchange {
    ...
    public function fetch_currencies($limit, $params = array ()) {
        return Async\async(function () use ($limit, $params) {
            $request = array(
                'limit' => $limit || 1000,
            );
    ...
    public function fetch_order($id, $params = array ()) {
        return Async\async(function () use ($id, $params) {
            ...
            $response = Async\await($this->$method (array_merge($request)));
            return $response;
        }) ();
    }
    ...
    public function fetch_ohlcv($symbol, $internal = '1m', $limit = 500, $params = array ()) {
        return Async\async(function () use ($symbol, $internal, $limit, $params) {
            $request = array(
                'symbol' => $symbol,
                'interval' => $internal,
                'limit' => $limit,
    ...
    public function create_order($symbol, $type, $side, $amount = null, $price = null, $quoteAmount = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $quoteAmount, $params) {
            $request = array(
                'symbol' => $symbol,
                'type' => $type,
                'side' => $side,
